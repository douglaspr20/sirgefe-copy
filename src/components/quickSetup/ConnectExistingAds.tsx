...
import {
  TextMainButtonType,
  useQuickSetupContext,
} from '@providers/quickSetupProvider';
            ...
            <>
              <div className="mt-5">
                {businessProfile?.google_ad_account_id && (
                  <ConnectedAcounts
                    type="Google"
                    acountName={businessProfile?.google_ad_account_id}
                ...
                {businessProfile?.facebook_ad_account_name && (
                  <ConnectedAcounts
                    type="Facebook"
                    acountName={businessProfile?.facebook_ad_account_name}
                ...
                {businessProfile?.tik_tok_ad_account_name && (
                  <ConnectedAcounts
                    type="TikTok"
                    acountName={businessProfile?.tik_tok_ad_account_name}

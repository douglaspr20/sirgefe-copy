...
import { AdAccountSettings } from './app/QuickSetup';
interface Props {
                ...
                API.graphql(
                  graphqlOperation(setUtmValuesSocialCampaign, {
                    setUtmValuesSocialCampaignInput: {
                      adId: item.id,
                      businessId: businessProfile?.profilePrisma?.id,
                      itemType: 'ads',
                      source: 'facebook',
                    },
                  }),
          ...
          {currentView === 'Connect all ads' ? (
            <>
              <div className="mt-5">
                {accounts?.google?.social_account_id && (
                  <ConnectedAcounts
                    type="Google"
                    acountName={accounts.google?.social_account_id}
                ...
                {accounts?.facebook?.social_account_name && (
                  <ConnectedAcounts
                    type="Facebook"
                    acountName={accounts?.facebook?.social_account_name}
                ...
                {accounts?.tiktok?.social_account_name && (
                  <ConnectedAcounts
                    type="TikTok"
                    acountName={accounts?.tiktok?.social_account_name}
            ...
            <div className="widget-container p-5 py-2">
              <ConnectCampaignsModal
                facebookAds={
                  accounts?.facebook?.social_account_name ? facebookAds : null
                }
                tiktokAds={
                  accounts?.tiktok?.social_account_name ? tiktokAds : null
                }
                googleAds={
                  accounts?.google?.social_account_id ? googleAds : null
                }

...
import { PlanDisplayName, PlanPrice } from '@sirge-io/sirge-types';
  ...
  return (
    <>
        ...
        <div className="flex items-center">
          <div className="ml-2">
            <h2 className="h5 ">
              {
                PlanDisplayName[
                  (subscription?.subscription_plan_code as keyof typeof PlanDisplayName) ||
                    'tier_1'
                ]
              }
            </h2>
      ...
      <div className="py-3 mb-3 items-center justify-between border-bottom-darkgrey">
        ...
        <div className="mt-3 flex w-full h-6 bg-darkGrade25 rounded-full overflow-hidden">
          <div
            ...
            style={{
              width: `
            ${getProgressWidth(subscription?.current_revenue || 0)}
              `,
            }}
          ></div>
        </div>
      ...
      <div className="py-2 mb-3 items-center justify-between grid grid-cols-2 grid-rows-3 w-max gap-x-4 gap-y-1">
        ...
        <p>${subscription?.current_revenue?.toFixed(0) || 0}</p>

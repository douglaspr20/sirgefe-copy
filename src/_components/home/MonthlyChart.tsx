...
import { IKeyMetricsMonthlyBudget } from '@interfaces/analytics';
    ...
    <>
      {(business as any)?.monthly_budget === null ? (
        ...
        <>
          ...
          <div className={`grid place-items-center min-h-[197px]`}>
            {!loadingGraph ? (
              <>
                {!spentPercentage ? (
                  <NoData />
                  ...
                  <div className="flex items-center" key={spentPercentage}>
                      ...
                      options={{
                        ...optionsDoughnutChart(
                          [
                            ...
                            'TikTok Ad Spent',
                            ...(process.env
                              .NEXT_PUBLIC_SHOW_GOOGLE_INTEGRATION === 'show'
                              ? ['Google Ad Spent']
                              : []),
                            'Ad Budget',
                          ],
                    ...
                    <div className="flex flex-col">
                      <span className="text-xs text-textTeriraryColor">
                        Ad Budget
                      </span>
                      <div className="text-darkGrade100 font-bold mb-4">
                        {formatMoneyWithDecimals(
                          business?.monthly_budget || 0,
                          currency ?? 'USD',
                        )}
                      </div>
